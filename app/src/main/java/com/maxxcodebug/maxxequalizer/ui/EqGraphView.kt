...
import com.maxxcodebug.maxxequalizer.dsp.SpectrumAnalyzer
...
class EqGraphView @JvmOverloads constructor(
    ...
    var spectrumRenderer: com.maxxcodebug.maxxequalizer.audio.SpectrumAnalyzerRenderer? = null
    ...
    private val defaultFrequencies: List<Float> by lazy {
        val all = com.maxxcodebug.maxxequalizer.dsp.ParametricEqualizer.logSpacedFrequencies(16)
        all.toList()
    }
